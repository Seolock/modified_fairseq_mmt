...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(
            ...
            src_tokens,
            src_lengths,
            imgs_list, # B x N(576) x 384 추측
            img_masks_list, # B x N 추측
    ...
    def reorder_encoder_out(self, encoder_out: EncoderOut, new_order):
        ...
        new_imgs_list = encoder_out.imgs_list
        if new_imgs_list is not None:
        ...
        return EncoderOut(
            ...
            img_masks_list=new_img_masks_list,
        )
    ...
    def extract_features_scriptable(
        ...
        for idx, layer in enumerate(self.layers):
            ...
            x, layer_attn, _ = layer(
                ...
                incremental_state,
                encoder_out.imgs_list if encoder_out is not None else None,
                encoder_out.img_masks_list if encoder_out is not None else None,
